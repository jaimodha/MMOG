...
from net.request.RequestSelectCharAndTeamType import RequestSelectCharAndTeamType
...
class ServerRequestTable:
    ...
    def __init__(self):
        ...
        self.add(Constants.CMSG_CREATE_CHARACTER,'RequestSelectCharAndTeamType')
