...
-- users table
insert into users values(1,"chintan","shah",false);
insert into users values(2,"paras","patel",false);

-- teams table
insert into teams values(1,0,20,20,0);
insert into teams values(2,1,-20,-20,0);

-- characters table
insert into characters values(1,"cs",0,1, 0);
insert into characters values(2,"pp",1,2, 1);