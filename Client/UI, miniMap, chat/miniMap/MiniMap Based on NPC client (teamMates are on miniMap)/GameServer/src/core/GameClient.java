...
public class GameClient extends Thread {
    ...
    public void run() {
        ...
        if (player != null) {
            try {
            	PlayerDAO.updateLogout(player.getPlayer_id(), player.getX(), player.getY(), player.getZ(), player.getRotation());
    ...
    public void stopClient() {
        ...
        responseExitGame.setID(player.getPlayer_id());
        this.server.addResponseForAllOnlinePlayers(player.getPlayer_id(), responseExitGame);
    }
