...
<a href="logout.jsp">Logout </a></c:if>-->
	...
	<div id="indexnew_hype_container" style="position:relative;overflow:hidden;width:1240px;height:800px;">
		<script type="text/javascript" charset="utf-8" src="indexnew.hyperesources/indexnew_hype_generated_script.js?81887"></script>
	</div>

				<a href = 'home.jsp' >Skip</a>
			</center>
